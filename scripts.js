document.addEventListener('DOMContentLoaded', function() {
    ...
    const seoConfigs = {
    'index': {
        title: 'Onur İnşaat - İnşaat Malzemeleri | 25 Yıllık Deneyim',
    ...
    'kategoriler': {
        title: 'Kategoriler - Onur İnşaat | Seramik Banyo Mutfak',
    ...
    'urunler': {
        title: 'Ürünler - Onur İnşaat | İnşaat Malzemeleri Kataloğu',
    ...
    'iletisim': {
        title: 'İletişim - Onur İnşaat | Adres Telefon Harita',
    ...
    'sepet': {
        title: 'Sepetim - Onur İnşaat | Alışveriş Sepeti',
    ...
    'favoriler': {
        title: 'Favorilerim - Onur İnşaat | Beğenilen Ürünler',
